...
export const midnightSeductressWardrobe: PlatinumWardrobeItem[] = [
  {
    id: 'ms-noir-silk',
...
export const fitnessBombshellWardrobe: PlatinumWardrobeItem[] = [
  {
    id: 'fb-sports-luxe',
...
export const graphicEditorialWardrobe: PlatinumWardrobeItem[] = [
  {
...
export const privateBoudoirWardrobe: PlatinumWardrobeItem[] = [
  {
    id: 'pb-lace-luxury',
...
export const luxuryLoungeWardrobe: PlatinumWardrobeItem[] = [
  {
...
export const spaTubWardrobe: PlatinumWardrobeItem[] = [
  {
    id: 'st-wet-silk',
...
export const rooftopMidnightWardrobe: PlatinumWardrobeItem[] = [
  {
    id: 'rm-urban-glam',
...
export const hotelSuiteWardrobe: PlatinumWardrobeItem[] = [
  {
    id: 'hs-hotel-robe',
...
export const undergroundClubWardrobe: PlatinumWardrobeItem[] = [
  {
    id: 'uc-neon-bodysuit',
...
export const artStudioWardrobe: PlatinumWardrobeItem[] = [
  {

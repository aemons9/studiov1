      ...
      <div className="bg-slate-800/40 border border-slate-700 p-5 rounded-xl">
         <label htmlFor="concept-select" className="flex items-center gap-2 text-lg font-bold text-cyan-300 mb-2">
          ...
          <select
            ...
            disabled={isLoading}
            className="w-full p-2.5 text-slate-200 bg-slate-900/70 border-2 border-slate-700 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-shadow duration-300"
          >

...
export const corporateSeductionCollection: ArtisticConcept[] = [
...

  {
    ...
    data: {
      ...
      subject: {
        variant: seductressVariant,
        pose: "Standing at floor-to-ceiling window, back to camera, looking out at city. One hand touching glass above head, other at her side. Elegant contrapposto stance creating natural curves.",
        hair_color: "jet black",
...

  {
    ...
    data: {
      ...
      material_properties: "Crisp cotton, delicate lace, and the warm wood desk create tactile material contrast."
    }
  },

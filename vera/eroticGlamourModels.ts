...
export const MODEL_SHOULDER_GODDESS: GlamourModel = {
  ...
  poseGallery: [
    ...
    },
    {
      ...
      name: 'Arms Raised Shoulder Emphasis',
  ...
  poseGallery: [
    {
      ...
      name: 'Leg Forward Thigh Emphasis',
  ...
  poseGallery: [
    {
      ...
      name: 'Classic Back View Posterior',
    ...
    },
    {
      ...
      name: 'Arched Back Posterior Emphasis',
    ...
    },
    {
      ...
      name: 'Forward Lean Posterior Showcase',
...
export const EROTIC_GLAMOUR_MODELS: GlamourModel[] = [
  MODEL_UPPER_REVEAL,
  MODEL_LOWER_CURVES,
  MODEL_SENSUAL_BOLD,

...
// ============================================================================
// SEDUCTRESS MAX COLLECTION - Premium Intimacy Level 10
// ============================================================================

export const SEDUCTRESS_MAX_CONCEPTS: ArtisticConcept[] = [
  {
    ...
    data: {
      ...
      subject: {
        variant: "Indian Glamour Seductress (height 5'8\", measurements 38DD-26-42) with warm honey complexion and golden undertones. Elite boudoir and fine-art nude specialist.",
  ...
  },
  {
    ...
    data: {
      ...
      subject: {
        variant: "Indian Glamour Seductress (height 5'8\", measurements 38DD-26-42) with warm honey complexion. Power and architecture specialist.",
  ...
  },
  {
    ...
    data: {
      ...
      subject: {
        variant: "Indian Glamour Seductress (height 5'8\", measurements 38DD-26-42) with warm honey complexion. Intimate boudoir specialist.",
  ...
  },
  {
    ...
    data: {
      ...
      subject: {
        variant: "Indian Glamour Seductress (height 5'8\", measurements 38DD-26-42) with warm honey complexion. Goddess and ethereal specialist.",
  ...
  },
  {
    ...
    data: {
      ...
      subject: {
        variant: "Indian Glamour Seductress (height 5'8\", measurements 38DD-26-42) with warm honey complexion. Film noir and vintage glamour specialist.",
  ...
  },
  {
    ...
    data: {
      ...
      subject: {
        variant: "Indian Glamour Seductress (height 5'8\", measurements 38DD-26-42) with warm honey complexion. Water goddess and natural element specialist.",
  ...
  },
  {
    ...
    data: {
      ...
      subject: {
        variant: "Indian Glamour Seductress (height 5'8\", measurements 38DD-26-42) with warm honey complexion. Intimate connection and emotional specialist.",
